...
class Po(models.Model):
    ...
    pandf1 = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    pandfamt = models.DecimalField(max_digits=14, decimal_places=3, blank=True, null=True)
    ex_duty1 = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    cst1 = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    vat1 = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    against = models.CharField(max_length=15, blank=True, null=True)
    deldate = models.DateField(blank=True, null=True)
    srtx1 = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
